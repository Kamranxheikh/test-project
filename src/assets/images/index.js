...
// New Arrivals
import newArrOne from "./products/newArrival/download.jpg";
import newArrTwo from "./products/newArrival/1.jpg";
import newArrThree from "./products/newArrival/download1.jpg";
import newArrFour from "./products/newArrival/download (1).jpg";

// Best Sellers
import bestSellerOne from "./products/bestSeller/1.jpg";
import bestSellerTwo from "./products/bestSeller/2.jpg";
import bestSellerThree from "./products/bestSeller/bestSellerThree.webp";
import bestSellerFour from "./products/bestSeller/4.jpg";
